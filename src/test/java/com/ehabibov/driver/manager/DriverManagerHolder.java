...
public final class DriverManagerHolder {
    ...
    private static DriverManagerLifecycle driverManagerPicker(final ApplicationConfig config) {
        return config.isRemoteDriver() ?
